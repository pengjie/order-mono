...
public class HnpOrderEntity implements Serializable {
    ...
    //订单明细
    private List<HnpDetailEntity> data ;
    

    public HnpOrderEntity(){
        
    }

    public HnpOrderEntity(String req_from, String mainOrderNo, Double totalAmount) {
    ...
    public List<HnpDetailEntity> getData() {
        return data;
    }

    public void setData(List<HnpDetailEntity> data) {
        this.data = data;
    }
